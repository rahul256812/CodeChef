# Introduction, Output, and Math Operators

This folder contains introductory exercises, multiple-choice questions (MCQs), and basic C programming challenges focusing on standard output (`printf`), escape sequences, and basic arithmetic operators.
